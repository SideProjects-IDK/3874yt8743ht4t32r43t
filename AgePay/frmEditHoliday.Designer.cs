...
namespace AgePay
{
    partial class frmEditHoliday
    {
        ...
        private void InitializeComponent()
        {
            ...
            label6.Location = new Point(533, 56);
            label6.Name = "label6";
            label6.Size = new Size(250, 22);
            label6.TabIndex = 4;
            label6.Text = "Total holidays this year";
            // 
            // label7
            // 
            label7.AutoSize = true;
            label7.Location = new Point(633, 25);
            label7.Name = "label7";
            label7.Size = new Size(150, 22);
            label7.TabIndex = 3;
            label7.Text = "Days in a year";
            // 
